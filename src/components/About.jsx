...
return (
    <div className='grid max-sm:grid-cols-1 sm:grid-cols-2 max-md:grid-cols-1 gap-1 overflow-x-hidden overflow-y-hidden'>
        <div className='h-max  dark:bg-zinc-800  max-md:pt-52  md:pt-52  lg:pt-52  lg:py-44 xl:py-32 px-12 animate-fade-up animate-once max-sm:hidden max-md:hidden max-lg:block'>
        <Image alt='Grad pic' className='rounded-lg' src={gradpic} height={500} width={700} />
        </div>
        <div className='h-max  max-sm:pt-52 max-md:pt-52  md:pt-52  lg:pt-52  animate-fade-up'>
